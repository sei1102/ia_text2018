...
int loopope = 0;
void setup() {
  arduino2 = new Arduino(this,"/dev/tty.usbmodem1421");
  //arduino2.pinMode(in1Pin,Arduino.OUTPUT);
  //arduino2.pinMode(in2Pin,Arduino.OUTPUT);
  size(700, 600);  // Stage size
  frameRate(100);  
  font = createFont("Ricty-Bold",20);
  textFont(font);
  textAlign(CENTER);
  rectMode(CENTER);
  ellipseMode(CENTER);  
...
// PRINT THE DATA AND VARIABLE VALUES
  ...
  if(BPM-preBPM > 10 && preBPM != 0){
       text(bibiriNum + "回 ビビリ~~wwww",600,170);
  }
